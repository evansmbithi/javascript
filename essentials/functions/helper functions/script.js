...
const addFigure = (dataObj) => {
  ...
  newImage.setAttribute("src", dataObj.image); //setSrcAttribute
  newImage.setAttribute("alt", dataObj.description); //setAltAttribute
  newImage.classList.add("backpack__image"); //add css class
  let newFigcaption = document.createElement("figcaption");
  newFigcaption.innerHTML = dataObj.description;
